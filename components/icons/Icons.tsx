...
export const UsersIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962a3.75 3.75 0 015.962 0L12 15.75l-2.962.981a3.75 3.75 0 01-5.962 0zM21 12.75a9 9 0 11-18 0 9 9 0 0118 0z" />
  </svg>
);
...
export const ChatBubbleLeftRightIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.722.26c-.341.024-.69.058-.99.093a9.05 9.05 0 01-9.224-9.224c.035-.3.069-.649.093-.99l.26-3.722A2.122 2.122 0 015.52 3h4.286c.969 0 1.813.616 2.097 1.511l.637 2.228A2.12 2.12 0 0113.102 9zM3.75 15.602c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.722.26c-.341.024-.69.058-.99.093a9.05 9.05 0 01-9.224-9.224c.035-.3.069-.649.093-.99l.26-3.722A2.122 2.122 0 015.52 15h4.286c.969 0 1.813.616 2.097 1.511l.637 2.228A2.12 2.12 0 0113.102 21z" />
  </svg>
);
...
export const ClipboardDocumentListIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 9h16.5v10.5a2.25 2.25 0 01-2.25 2.25H6a2.25 2.25 0 01-2.25-2.25V9z" />
    </svg>
);
